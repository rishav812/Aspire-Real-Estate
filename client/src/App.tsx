    ...
    <div className="App">
      <Routes>
        ...
        <Route
          ...
          element={
            <PrivateRoutes Component={ForgotPassword} route={RoutesPath.FORGOT_PASSWORD} />
          }
        />
        <Route
          path={RoutesPath.OTP_VERIFICATION}
          element={
            <PrivateRoutes Component={OtpVerification} route={RoutesPath.OTP_VERIFICATION} />
          }
        />
        <Route
          path={RoutesPath.RESET_PASSWORD}
          element={
            <PrivateRoutes Component={ResetPassword} route={RoutesPath.RESET_PASSWORD} />
          }
        />
        <Route
          path={RoutesPath.USERDASHBOARD}
          element={ isAdmin===false || isAdmin===undefined ?(
        ...
        <Route
          ...
          element={ isAdmin?(
            <WithHeader Component={AdminProfile} route={RoutesPath.ADMINPROFILE}/>):(
              <WithHeader Component={NotFound} route={RoutesPath.UNAUTHORIZED}/>
            )
          }
        />
